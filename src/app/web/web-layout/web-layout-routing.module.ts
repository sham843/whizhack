...
const routes: Routes = [
  ...
  { path: 'cyber-range', loadChildren: () => import('../../web/products/cyber-range/cyber-range.module').then(m => m.CyberRangeModule), data: { breadcrumb: [{ title: 'Cyber Range', active: true }] } },
  { path: 'trace', loadChildren: () => import('../../web/products/trace/trace.module').then(m => m.TraceModule), data: { breadcrumb: [{ title: 'Trace', active: true }] } },
  { path: 'zero-hack', loadChildren: () => import('../../web/products/zero-hack/zero-hack.module').then(m => m.ZeroHackModule), data: { breadcrumb: [{ title: 'Zero Hack', active: true }] } },
  ...
  { path: 'bootcampt', loadChildren: () => import('../../web/training/bootcampt/bootcampt.module').then(m => m.BootcamptModule), data: { breadcrumb: [{ title: 'Bootcampt', active: true }] } },
