...
const routes: Routes = [
  ...
  { path: 'cyber-range', loadChildren: () => import('../../web/products/cyber-range/cyber-range.module').then(m => m.CyberRangeModule) },
  { path: 'trace', loadChildren: () => import('../../web/products/trace/trace.module').then(m => m.TraceModule) },
  { path: 'zero-hack', loadChildren: () => import('../../web/products/zero-hack/zero-hack.module').then(m => m.ZeroHackModule) },
